    ...
    <>
      ...
      <section className="section">
        <div className="wrap grid gap-14 md:gap-20">
          ...
          <FeatureRow k="Repairs" title="Track it to the last photo." body="Approve a repair and watch it move from Requested to Completed in real time. The provider's completion note and after-photos land in the same record as the original issue." bullets={["Only verified, locality-matched providers — quote + flat 10% fee, you approve the exact amount", "Work happens during a visit, inspector on-site the whole time", "Live status — no refreshing; rate the provider when it's done"]}><div className="mx-auto max-w-[420px]"><ResolveMock /></div></FeatureRow>
        </div>
      </section>
