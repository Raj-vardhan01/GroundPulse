...
const faqs = [
  ...
  { q: "What does it cost?", a: "For homes up to 2 BHK: a one-time visit is ₹1,999, Care is ₹7,999 a year (4 inspections + 2 full house cleanings) and Care+ is ₹14,999 a year (adds 2 maintenance services with repairs covered up to ₹25,000). For 3 BHK it's ₹2,499 / ₹9,999 / ₹19,999 and for 4 BHK+ it's ₹2,999 / ₹11,999 / ₹24,999. Add-ons on any plan: refresh clean ₹899, full deep clean from ₹3,499, car ₹700, plot visit ₹1,999." },
  ...
  { q: "What's the difference between a refresh clean and a deep clean?", a: "A place that has simply been shut for a few months needs dust removed, not grease. The refresh clean (₹899, about two hours, one person) does cobwebs, fans, floors swept and mopped, surfaces and sills wiped, bathroom surfaces, and every tap and trap run so the seals don't dry out. The full deep clean (from ₹3,499 for 2 BHK, ₹4,499 for 3 BHK, ₹5,499 for 4 BHK+) is a crew of two or three for four to six hours: chimney and hob degreased, cabinets inside and out, bathroom tiles and grout scrubbed, WC descaled, windows and grills, skirting, switchboards, the lot — with before and after photographs of every room. Care and Care+ include two refresh cleans a year; deep cleans are booked when you need one, usually right before you visit." },
  { q: "Can you get the place ready before I arrive?", a: "That's what the Coming home package is for, and it's the thing no cleaning app can do — every one of them needs somebody at home to let the crew in, which is exactly what you don't have. Book two or three days before you land. Your inspector enters on your OTP, runs the full checklist, supervises the deep-clean crew for the entire time they're in the house, and photographs every room before and after. Anything broken is flagged with a quote, and if you approve it, it's repaired before you arrive. Inspection plus deep clean starts at ₹5,498." },
